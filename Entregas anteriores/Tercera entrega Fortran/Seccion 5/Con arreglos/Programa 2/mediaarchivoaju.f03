...
REAL,DIMENSION(0:900)::b        ! guaradra los valores del archivo
...
IF (primero==0)THEN
         ...
         leerarch:DO
                  READ(33,*,IOSTAT=segundo) b(N)
                  
                  IF(.NOT.segundo==0)EXIT
                  N=N+1
                  producto= producto*b(N)
                  sumita= sumita+b(N)
